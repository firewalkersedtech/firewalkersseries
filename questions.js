const allExamData = {
    ...
    // =================================================================
    // DATA FOR: 12 Sep 2025 | Shift-1 (Mapped to Shift-3 Button for visibility)
    // =================================================================
    "12 Sep 2025 | Shift-3 (04:00 PM)": [
        
        // --- SECTION 1: REASONING (1-25) ---
        {
        ...
        },
        {
            ...
            correct: "A" // NKYD (Assumed based on pattern)
        },
        {
        ...
        },
        {
            ...
            text: "Identify the pattern and find the missing term.\n\nTIME : VJOG :: WORD : ?",
        ...
        },
        {
            ...
            text: "In a certain code, AYRRJC : CATTLE :: NCPDCAR : ?",
            options: ["SUBJECTS", "NEGLECT", "PERFECT", "OPERATE"],
            correct: "D" // OPERATE
        },
        {
            id: 17, section: "Reasoning",
            text: "Identify the odd number from the list: 2, 3, 5, 7, 11, 13, 17, 20",
            options: ["17", "13", "20", "11"],
            correct: "C" // 20 (Only even/non-prime)
        },
        {
            id: 18, section: "Reasoning",
            text: "Which of the following number sets is the odd one out?",
            options: ["2,3,5", "11,13,17", "4,6,8", "7,19,23"],
            correct: "C" // 4,6,8 (Even numbers)
        },
        {
        ...
        },
        {
            ...
            correct: "D" // N14:K11:H8
        },
        {
            id: 21, section: "Reasoning",
            text: "Identify the group that does NOT follow the same pattern (Symbols).",
        ...
        // --- SECTION 2: GENERAL AWARENESS (26-50) ---
        {
            ...
            options: ["Buddhist caves with large stupas", "Shaivite themes and sculptural depth", "Jain depictions", "Monolithic structures from Mauryan period"],
            correct: "B"
        },
        {
            id: 27, section: "GK",
            text: "Goncha Festival of Bastar: 1. Tupki uses Goncha fruit. 2. Chariot by Chalukya. 3. Rath Yatra dates. Which are correct?",
        ...
        },
        {
            ...
            options: ["Introduced in 1882 by Jigoro Kano", "First National 1970", "Kalpana Devi won gold", "Olympic sport in 1965"],
            correct: "A"
        },
        {
            id: 30, section: "GK",
            text: "Where and when will the 59th National Cross Country Championships - 2025 be held?",
            options: ["10 Jan, Lucknow", "12 Jan, Meerut", "15 Jan, Kanpur", "12 Jan, Jaipur"],
            correct: "D"
        },
        {
            id: 31, section: "GK",
        ...
        {
            id: 32, section: "GK",
            text: "The Santosh Trophy 2022-23 final was uniquely held in ____ where Karnataka defeated Meghalaya.",
        ...
        {
            id: 34, section: "GK",
            text: "Glacial landforms: 1. Hanging valleys opening into main valleys. 2. Truncated spurs into triangular facets.",
        ...
        },
        {
            ...
            options: ["Guide to orbit", "Eject crew module to safety", "Docking", "Thermal shielding"],
            correct: "B"
        },
        {
            id: 36, section: "GK",
        ...
        {
            id: 41, section: "GK",
            text: "For a rigid body, angular velocity of any particle about a given axis is:",
        ...
        {
            id: 44, section: "GK",
            text: "Cheraw (bamboo dance) is a folk dance of which state?",
            options: ["Mizoram", "Meghalaya", "Arunachal Pradesh", "Sikkim"],
            correct: "A"
        },
        {
            id: 45, section: "GK",
        ...
        {
            id: 47, section: "GK",
            text: "Education is placed under which list after 42nd Amendment?",
        ...
        {
            id: 57, section: "Quant",
            text: "Average of integers between 100 and 250 exactly divisible by 11?",
